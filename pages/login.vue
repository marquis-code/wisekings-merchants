  ...
  <div class="min-h-screen flex items-center justify-center bg-dark-950 p-4">
    <div class="w-full max-w-md">
      <div class="text-center mb-8">
        <div class="inline-flex w-16 h-16 rounded-2xl bg-gradient-to-br from-emerald-500 to-emerald-700 items-center justify-center mb-4"><span class="text-2xl font-bold text-white">M</span></div>
        <h1 class="text-2xl font-bold text-white">Merchant Portal</h1>
        <p class="text-dark-400 mt-1">Sign in to your merchant account</p>
      </div>

<template>
  <div>
    <div class="mb-10 text-center lg:text-left">
      ...
      <p class="text-gray-500 font-medium">Please enter your details to sign in and manage your business.</p>
    </div>
    ...
    <form @submit.prevent="handleLogin()" class="space-y-6">
      <div class="space-y-5">
        ...
        <div class="space-y-2">
          <div class="flex items-center justify-between px-1">
            ...
            <NuxtLink to="/forgot-password" class="text-sm font-bold text-emerald-600 hover:text-emerald-700 transition-colors">Forgot password?</NuxtLink>
          </div>
          <div class="relative group">
            <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-gray-400 group-focus-within:text-emerald-600 transition-colors">
      ...
      <div class="pt-4 text-center">
        <p class="text-gray-500 font-medium">
          ...
          <NuxtLink to="/signup" class="text-emerald-600 font-extrabold hover:text-orange-700 transition-colors">Apply now</NuxtLink>
        </p>
      </div>
    </form>
  </div>
...
useSeoMeta({
  title: 'Merchant Login | WiseKings Business',
  description: 'Access your merchant dashboard to manage inventory, orders, and business growth.',
})

<template>
  <div>
    <div class="mb-10 text-center lg:text-left">
      <h2 class="text-3xl font-extrabold text-gray-900 mb-2">Create Merchant Account</h2>
      <p class="text-gray-500 font-medium">Join us as a Merchant and start selling your snacks today.</p>
    </div>

    <form @submit.prevent="handleSignup" class="space-y-6">
      <div class="space-y-4">
        <div class="space-y-2">
          <label for="companyName" class="text-sm font-semibold text-gray-700 ml-1">Company / Store Name</label>
          <div class="relative group">
            ...
            <input 
              ...
              type="text" 
              placeholder="Your Amazing Snack Store"
              required
              class="block w-full pl-11 pr-4 py-3.5 bg-gray-50 border border-gray-200 rounded-2xl text-gray-900 focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-600 transition-all outline-none font-medium placeholder:text-gray-400"
            >
          </div>
        </div>
        ...
        <div class="space-y-2">
          ...
          <div class="relative group">
            ...
            <input 
              ...
              placeholder="••••••••"
              required
              class="block w-full pl-11 pr-12 py-3.5 bg-gray-50 border border-gray-200 rounded-2xl text-gray-900 focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-600 transition-all outline-none font-medium placeholder:text-gray-400"
            >
            <button 
              type="button"
      ...
      <div class="pt-4 text-center">
        <p class="text-gray-500 font-medium">
          ...
          <NuxtLink to="/login" class="text-emerald-600 font-extrabold hover:text-emerald-700 transition-colors">Sign in</NuxtLink>
        </p>
      </div>
    </form>
  </div>
...
async function handleSignup() {
  const res = await signup({
    fullName: form.companyName, // Using company name as full name for now
    email: form.email,

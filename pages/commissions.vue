  ...
  <div>
    ...
    <div class="table-container">
      <table class="data-table">
        <thead><tr><th>Order</th><th>Amount</th><th>Rate</th><th>Status</th><th>Date</th></tr></thead>
        <tbody>
          ...
          <tr v-else-if="items.length === 0"><td colspan="5" class="text-center py-12 text-dark-400">No commissions yet</td></tr>

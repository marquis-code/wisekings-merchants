<template>
  <div>
    ...
    <div v-if="referrals.length === 0" class="text-center py-20 text-dark-400">No referrals yet. Share your referral link to start earning!</div>
    <div v-else class="table-container">
      <table class="data-table">
        <thead><tr><th>Customer</th><th>Status</th><th>Joined</th></tr></thead>

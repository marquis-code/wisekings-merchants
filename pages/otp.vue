  ...
  <main class="w-full">
    ...
    <form @submit.prevent="handleVerify" class="space-y-8 max-w-md">
      <div>
        <div class="flex gap-3 justify-between">
          <input 
            ...
            type="text"
            maxlength="1"
            class="w-12 h-14 text-center text-2xl font-bold text-gray-900 bg-gray-50 border-2 border-gray-100 rounded-xl focus:bg-white focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10 outline-none transition-all placeholder:text-gray-300"
      ...
      <button
        ...
        class="w-full flex items-center justify-center py-4 px-6 rounded-2xl text-white font-bold text-lg transition-all focus:outline-none focus:ring-4 focus:ring-emerald-500/20 active:scale-[0.98] disabled:opacity-70 disabled:cursor-not-allowed bg-black hover:bg-gray-900 shadow-lg shadow-black/10"
      >
      ...
      <div class="text-center">
        <p class="text-gray-500 font-medium">
          ...
          <button 
            ...
            class="text-emerald-600 font-bold hover:text-emerald-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          >

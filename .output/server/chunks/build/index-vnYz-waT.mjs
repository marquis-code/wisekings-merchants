...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const statsCards = computed(() => {
      var _a, _b, _c, _d;
      return [
        { label: "Total Sales", value: `\u20A6${((((_a = stats.value) == null ? void 0 : _a.totalSalesValue) || 0) / 1e3).toFixed(0)}k`, icon: "lucide:trending-up", iconColor: "text-emerald-400" },
        ...
        { label: "Orders Referred", value: ((_c = stats.value) == null ? void 0 : _c.totalOrdersReferred) || 0, icon: "lucide:shopping-cart", iconColor: "text-purple-400" },
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--></div><div class="card mb-6"><h2 class="text-lg font-semibold text-white mb-3">Referral Link</h2><div class="flex items-center gap-2"><input${ssrRenderAttr("value", (_a = unref(profile)) == null ? void 0 : _a.referralLink)} readonly class="input flex-1"><button class="btn-secondary btn-sm">`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "lucide:copy",
        class: "w-4 h-4"
      }, null, _parent));
      ...
      ssrRenderList(unref(orders), (o) => {
        var _a2;
        _push(`<div class="flex items-center justify-between py-2 border-b border-dark-700/50 last:border-0"><div><p class="text-sm font-medium text-dark-200">${ssrInterpolate(o.orderNumber)}</p><p class="text-xs text-dark-400">\u20A6${ssrInterpolate((_a2 = o.totalAmount) == null ? void 0 : _a2.toLocaleString())}</p></div><span class="${ssrRenderClass(o.status === "delivered" ? "badge-success" : "badge-warning")}">${ssrInterpolate(o.status)}</span></div>`);
      });
...
//# sourceMappingURL=index-vnYz-waT.mjs.map

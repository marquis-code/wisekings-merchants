...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const withdrawForm = ref({ amount: 0, bankDetails: { bankName: "", accountNumber: "", accountName: "" } });
...
//# sourceMappingURL=wallet-D34S7Yp9.mjs.map

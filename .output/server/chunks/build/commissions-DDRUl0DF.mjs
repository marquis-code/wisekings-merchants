...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<h1 class="text-2xl font-bold text-white mb-6">My Commissions</h1><div class="table-container"><table class="data-table"><thead><tr><th>Order</th><th>Amount</th><th>Rate</th><th>Status</th><th>Date</th></tr></thead><tbody>`);
      if (unref(loading)) {
...
//# sourceMappingURL=commissions-DDRUl0DF.mjs.map

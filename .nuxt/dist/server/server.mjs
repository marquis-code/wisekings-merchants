...
import { $fetch as $fetch$1 } from "/Users/mac/Documents/wisekings/merchant/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "/Users/mac/Documents/wisekings/merchant/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/Users/mac/Documents/wisekings/merchant/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, appendHeader, getRequestHeader, setCookie, getCookie, deleteCookie, getRequestURL } from "/Users/mac/Documents/wisekings/merchant/node_modules/h3/dist/index.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, useRoute as useRoute$1, RouterView } from "vue-router";
import { defu, defuFn, createDefu } from "/Users/mac/Documents/wisekings/merchant/node_modules/defu/dist/defu.mjs";
import { hasProtocol, joinURL, parseURL, encodePath, decodePath, withQuery, isScriptProtocol, parsePath, parseQuery, withoutTrailingSlash } from "/Users/mac/Documents/wisekings/merchant/node_modules/ufo/dist/index.mjs";
import { parse as parse$1 } from "/Users/mac/Documents/wisekings/merchant/node_modules/nuxt/node_modules/cookie-es/dist/index.mjs";
import destr from "/Users/mac/Documents/wisekings/merchant/node_modules/destr/dist/index.mjs";
import { isEqual } from "/Users/mac/Documents/wisekings/merchant/node_modules/ohash/dist/index.mjs";
import { klona } from "/Users/mac/Documents/wisekings/merchant/node_modules/klona/dist/index.mjs";
import { useHead as useHead$1, headSymbol, useSeoMeta as useSeoMeta$1 } from "/Users/mac/Documents/wisekings/merchant/node_modules/@unhead/vue/dist/index.mjs";
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/kyc-BivTpntJ.js")
  },
  {
    name: "otp",
    path: "/otp",
    meta: __nuxt_page_meta$g || {},
    component: () => import("./_nuxt/otp-r6ihzdx1.js")
  },
  {
    name: "chat",
    path: "/chat",
    meta: __nuxt_page_meta$f || {},
    component: () => import("./_nuxt/chat-BF6YPu7m.js")
  },
  {
    name: "wssp",
    path: "/wssp",
    meta: __nuxt_page_meta$e || {},
    component: () => import("./_nuxt/wssp-DnbbcI5I.js")
  },
  {
    name: "index",
    path: "/",
    meta: __nuxt_page_meta$d || {},
    component: () => import("./_nuxt/index-BLONmr4q.js")
  },
  {
    name: "login",
    path: "/login",
    meta: __nuxt_page_meta$c || {},
    component: () => import("./_nuxt/login-CuzYoCxp.js")
  },
  {
    name: "terms",
    path: "/terms",
    meta: __nuxt_page_meta$b || {},
    component: () => import("./_nuxt/terms-BxEe8ZFY.js")
  },
  {
    name: "orders",
    path: "/orders",
    meta: __nuxt_page_meta$a || {},
    component: () => import("./_nuxt/orders-D2zzDUa8.js")
  },
  {
    name: "signup",
    path: "/signup",
    meta: __nuxt_page_meta$9 || {},
    component: () => import("./_nuxt/signup-BcVsoaXr.js")
  },
  {
    name: "wallet",
    path: "/wallet",
    meta: __nuxt_page_meta$8 || {},
    component: () => import("./_nuxt/wallet-D7PLUrjy.js")
  },
  {
    name: "privacy",
    path: "/privacy",
    meta: __nuxt_page_meta$7 || {},
    component: () => import("./_nuxt/privacy-DK_uGL-w.js")
  },
  {
    name: "profile",
    path: "/profile",
    meta: __nuxt_page_meta$6 || {},
    component: () => import("./_nuxt/profile-CE1maNKN.js")
  },
  {
    name: "welcome",
    path: "/welcome",
    meta: __nuxt_page_meta$5 || {},
    component: () => import("./_nuxt/welcome-BJLMgoiI.js")
  },
  {
    name: "referrals",
    path: "/referrals",
    meta: __nuxt_page_meta$4 || {},
    component: () => import("./_nuxt/referrals-D2ef4bKh.js")
  },
  {
    name: "commissions",
    path: "/commissions",
    meta: __nuxt_page_meta$3 || {},
    component: () => import("./_nuxt/commissions-Jo7zXSB3.js")
  },
  {
    name: "shelf-check",
    path: "/shelf-check",
    meta: __nuxt_page_meta$2 || {},
    component: () => import("./_nuxt/shelf-check-36oobGU1.js")
  },
  {
    name: "reset-password",
    path: "/reset-password",
    meta: __nuxt_page_meta$1 || {},
    component: () => import("./_nuxt/reset-password-Cr8V2NrM.js")
  },
  {
    name: "forgot-password",
    path: "/forgot-password",
    meta: __nuxt_page_meta || {},
    component: () => import("./_nuxt/forgot-password-CrWQHhl0.js")
  }
];
...
function useAuthState() {
  function setAuth(userData, tokens) {
    const token = "accessToken" in tokens ? tokens.accessToken : tokens.accessToken;
    const refresh2 = "refreshToken" in tokens ? tokens.refreshToken : tokens.refreshToken;
    accessToken.value = token;
    refreshTokenValue.value = refresh2;
    user.value = userData;
    useCookie("wk_merchant_token", { maxAge: 604800 }).value = token;
    useCookie("wk_merchant_refresh", { maxAge: 604800 }).value = refresh2;
  ...
  function logout() {
    ...
    user.value = null;
    useCookie("wk_merchant_token").value = null;
    useCookie("wk_merchant_refresh").value = null;
    useCookie("wk_merchant_user").value = null;
  }
  async function refresh() {
    if (!refreshTokenValue.value) return false;
    try {
      const config = /* @__PURE__ */ useRuntimeConfig();
      const r = await $fetch(`${config.public.apiBase}/auth/refresh`, { method: "POST", body: { refreshToken: refreshTokenValue.value } });
      if (r?.data?.tokens) {
        setAuth(r.data.user || user.value, r.data.tokens);
        return true;
      }
      ;
      return false;
...
const LazyIcon = defineAsyncComponent(() => import("./_nuxt/index-BUGJ0RvI.js").then((r) => r["default"] || r.default || r));
...
const localeLoaders = {
  en: [
    {
      key: "locale_en_46json_4f0db60f",
      load: () => import(
        "./_nuxt/en-IFBlIv4P.js"
        /* webpackChunkName: "locale_en_46json_4f0db60f" */
      ),
      cache: true
    }
  ],
  fr: [
    {
      key: "locale_fr_46json_3a846b3f",
      load: () => import(
        "./_nuxt/fr--Hqhnjz8.js"
        /* webpackChunkName: "locale_fr_46json_3a846b3f" */
      ),
      cache: true
    }
  ],
  es: [
    {
      key: "locale_es_46json_a8b9339b",
      load: () => import(
        "./_nuxt/es-1h6hG6-1.js"
        /* webpackChunkName: "locale_es_46json_a8b9339b" */
      ),
      cache: true
    }
  ]
...
function createNuxtI18nContext(nuxt, vueI18n, defaultLocale) {
  ...
  const loadMessagesFromServer = async (locale) => {
    ...
    const messages = await $fetch(`${"/_i18n/eGxpBfa7"}/${locale}/messages.json`, { headers });
...
const i18n_EI7LsD1KYQADczz5hrChviGQCdVM8yUkvFEZLJpmnvM = /* @__PURE__ */ defineNuxtPlugin({
  ...
  async setup(_nuxt) {
    ...
    prerenderRoutes(localeCodes.map((locale) => `${"/_i18n/eGxpBfa7"}/${locale}/messages.json`));
...
const layouts = {
  auth: defineAsyncComponent(() => import("./_nuxt/auth-CBNTrjxN.js").then((m) => m.default || m)),
  chat: defineAsyncComponent(() => import("./_nuxt/chat-W2w4ZYkZ.js").then((m) => m.default || m)),
  dashboard: defineAsyncComponent(() => import("./_nuxt/dashboard-CrQ09Kn9.js").then((m) => m.default || m)),
  default: defineAsyncComponent(() => import("./_nuxt/default-YMvQp4Bw.js").then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-DKTojDsm.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-DN5lCHc6.js"));
